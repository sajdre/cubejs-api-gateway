...
const cached_handler_1 = require("../src/cached-handler");
const createAsyncLock = (timeout) => new Promise((resolve) => {
...
describe('cachedHandler', () => {
    test('works', async () => {
        ...
        const handler = cached_handler_1.cachedHandler(async (req, res) => {
            reqPassed++;
...
//# sourceMappingURL=cached-handler.test.js.map